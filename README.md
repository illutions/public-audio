# Illutions Engine Audio Example

This example combines three spatially positioned instruments with distance-aware audio, orbit-controlled camera
movement, and realistic EXR environment lighting in just a few lines of Illutions Engine configuration.

## Live demo

[![Illutions Engine Audio example](.github/assets/screenshot.png)](https://illutions.github.io/public-audio/)

**[Launch the interactive demo](https://illutions.github.io/public-audio/)**
and move around the instruments to experience distance-aware spatial sound.

## What this example demonstrates

- One-click browser audio activation for three looping positional audio sources
- Distance-aware spatial sound for guitar, drums, and saxophone
- An audio listener attached to the active scene camera
- Orbit controls enabled after audio activation for rotating, panning, and
  zooming
- Direct GLTF/GLB model loading and EXR environment lighting
- Antialiased rendering configured through TypeScript
